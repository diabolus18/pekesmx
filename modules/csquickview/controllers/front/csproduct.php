...
class csquickviewCsProductModuleFrontController extends ModuleFrontController
{
	...
	public function initContent()
	{
		...
		$this->setTemplate('csproduct.tpl');
	}
	...
	public function display()
	{
		...
		if ($this->display_header)
			$this->smartyOutputContent(_PS_MODULE_DIR_.'csquickview/views/templates/front/header.tpl');
		...
		if ($this->display_footer)
			$this->smartyOutputContent(_PS_MODULE_DIR_.'csquickview/views/templates/front/footer.tpl');
