						...
						{assign var="sub_categories" value=$option['sub_category']['children']}
							...
							{while $ul < $li}
								{if isset($sub_categories[$ul])}
									...
									<li class="category_item{if isset($option['content_option']->opt_show_sub_cat) && $option['content_option']->opt_show_sub_cat == 1 &&$category['children']} parent{/if}">
										...
										{/if}
										{$category.name}</a>
										{if isset($option['content_option']->opt_show_sub_cat) && $option['content_option']->opt_show_sub_cat == 1}
							...
							{while $ul < $li}
								{if isset($option['product_list'][$ul])}
									...
									<div class="center_block">
										...
										<h3><a alt="{$product.name|escape:'htmlall':'UTF-8'}" title="" href="{$product.link}">{$product.name|escape:'htmlall':'UTF-8'}</a></h3></div>
