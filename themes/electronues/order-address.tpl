...
{/if}
	<div class="addresses fieldset clearfix">
		...
		{if $addresses|@count > 1}
			...
			{else}
				<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1&select_address=1{if $back}&mod={$back}{/if}")|escape:'html'}" title="{l s='Add'}" class="csbutton cssecond">{l s='Add a new address'}</a>
			{/if}
		</p>
		<div class="clearfix">
		...
		<p class="address_add submit">
			<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1{if $back}&mod={$back}{/if}")|escape:'html'}" title="{l s='Add'}" class="csbutton cssecond">{l s='Add a new address'}</a>
		</p>
		{if !$opc}
...
{if !$opc}
	<p class="cart_navigation submit">
		...
		<a href="{$link->getPageLink($back_order_page, true, NULL, "step=0{if $back}&back={$back}{/if}")|escape:'html'}" title="{l s='Previous'}" class="csbutton cssecond">&laquo; {l s='Previous'}</a>
		<input type="submit" name="processAddress" value="{l s='Next'} &raquo;" class="csbutton csdefault" />
	</p>
</form>
{else}
</div>
