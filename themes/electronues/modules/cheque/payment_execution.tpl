...
<h3 class="title1">{l s='Check payment' mod='cheque'}</h3>
<br/>
<form action="{$link->getModuleLink('cheque', 'validation', [], true)|escape:'html'}" method="post">
	...
	<p class="cart_navigation" id="cart_navigation">		
		<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html'}" class="csbutton cssecond">{l s='Other payment methods' mod='cheque'}</a>
		<input type="submit" value="{l s='I confirm my order' mod='cheque'}" class="csbutton csdefault" />
	</p>
</form>
{/if}
