...
<!-- Block stores module -->
<div id="stores_block_left" class="box1">
	<div class="title"><h3><a href="{$link->getPageLink('stores')}" title="{l s='Our stores' mod='blockstore'}">{l s='Our stores' mod='blockstore'}</a></h3></div>
	<div class="box-content blockstore">
