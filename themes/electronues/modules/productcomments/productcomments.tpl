...
<div id="mobile_tab_comment" class="title_hide_show title" style="display:none">{l s='Comments' mod='productcomments'}</div>
				...
				<div class="comment_details">
					...
					<ul>
						...
						{if $logged == 1}
							...
							<li>{l s='Was this comment useful to you?' mod='productcomments'}<button class="csbutton csdefault usefulness_btn" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">{l s='yes' mod='productcomments'}</button><button class="csbutton cssecond usefulness_btn" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">{l s='no' mod='productcomments'}</button></li>
							{/if}
		...
		<form id="id_new_comment_form" action="#">
			...
			<div class="new_comment_form_content">
				...
				<div id="new_comment_form_footer">
					...
					<p class="fr">
						<button id="submitNewMessage" class="csbutton csdefault" name="submitMessage" type="submit">{l s='Send' mod='productcomments'}</button>
						<a class="csbutton cssecond" href="#" onclick="$.fancybox.close();">{l s='Cancel' mod='productcomments'}</a>
					</p>
					<div class="clearfix"></div>
				</div>
			</div>
