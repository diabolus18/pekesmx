...
<div id="manufacturers_block_left" class="blockmanufacturer box1" data-animate="fadeInDown" data-delay="0">
	<div class="title"><h3>{if $display_link_manufacturer}<a href="{$link->getPageLink('manufacturer')}" title="{l s='Manufacturers' mod='blockmanufacturer'}">{/if}{l s='Manufacturers' mod='blockmanufacturer'}{if $display_link_manufacturer}</a>{/if}</h3></div>
