...
<div class="grid_4 myaccount" data-animate="fadeInLeft" data-delay="0">
	...
	<div class="block_content">
		<ul class="bullet">
			...
			{if $logged}<li class="logout"><a href="{$link->getPageLink('index')}?mylogout" title="{l s='Sign out' mod='blockmyaccountfooter'}" rel="nofollow">{l s='Sign out' mod='blockmyaccount'}</a></li>{/if}
