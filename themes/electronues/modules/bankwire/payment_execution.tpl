...
<h3 class="title1">{l s='Bank-wire payment.' mod='bankwire'}</h3><br/>
...
<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html'}" class="csbutton cssecond">{l s='Other payment methods' mod='bankwire'}</a>
<input type="submit" name="submit" value="{l s='Place my order' mod='bankwire'}" class="csbutton csdefault" />	
</p>
</form>
{/if}
