...
*}
<div id="wishlist_block" class="box1 account">
	<div class="title"><h3 class="title_block">
	...
	<div class="box-content">
		...
		<div class="lnk">
			...
			{/if}
			<a class="csbutton cssecond" href="{$link->getModuleLink('blockwishlist', 'mywishlist', array(), true)|addslashes}" title="{l s='My wishlists' mod='blockwishlist'}">
				<span>
