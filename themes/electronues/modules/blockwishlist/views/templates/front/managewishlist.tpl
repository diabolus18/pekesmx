...
{if $products}
    {if !$refresh}
        ...
        <ul class="unstyled clearfix display_list">
            <li>
        ...
        <p class="submit">
            <a id="showSendWishlist" class="csbutton csdefault" href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="{l s='Send this wishlist' mod='blockwishlist'}">
    ...
    <div class="wlp_bought">
        ...
        <ul class="unstyled row wlp_bought_list">
                ...
                <li id="wlp_{$product.id_product}_{$product.id_product_attribute}"
                    ...
                    <div class="row">
                            ...
                            <div class="product_infos">
                                <a class="lnkdel icon delete" href="javascript:;" onclick="WishlistProductManage('wlp_bought', 'delete', '{$id_wishlist}', '{$product.id_product}', '{$product.id_product_attribute}', $('#quantity_{$product.id_product}_{$product.id_product_attribute}').val(), $('#priority_{$product.id_product}_{$product.id_product_attribute}').val());" title="{l s='Delete' mod='blockwishlist'}">
                                    delete
                                </a>
                                ...
                                <div class="btn_action">
                                    <a class="csbutton csdefault"  href="javascript:;" onclick="WishlistProductManage('wlp_bought_{$product.id_product_attribute}', 'update', '{$id_wishlist}', '{$product.id_product}', '{$product.id_product_attribute}', $('#quantity_{$product.id_product}_{$product.id_product_attribute}').val(), $('#priority_{$product.id_product}_{$product.id_product_attribute}').val());" title="{l s='Save' mod='blockwishlist'}">
    ...
    {if !$refresh}
        <form method="post" class="wl_send unvisible clearfix" onsubmit="return (false);">
            <fieldset>
                ...
                <div class="form-group submit">
                    <button class="csbutton csdefault" type="submit" name="submitWishlist"
        ...
        {if count($productsBoughts)}
            <table class="wlp_bought_infos unvisible table table-bordered table-responsive std">
                <thead>
                <tr>
