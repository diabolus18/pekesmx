...
<div id="favoriteproducts_block_account">
	...
	{if $favoriteProducts}
		<div>
			...
			<div class="favoriteproduct clearfix">
				...
				<h3><a href="{$link->getProductLink($favoriteProduct.id_product, null, null, null, null, $favoriteProduct.id_shop)|escape:'htmlall':'UTF-8'}">{$favoriteProduct.name|escape:'htmlall':'UTF-8'}</a></h3></div>
				<p class="product_desc">{$favoriteProduct.description_short|strip_tags|escape:'htmlall':'UTF-8'}</p>

				<div class="remove">
					<img rel="ajax_id_favoriteproduct_{$favoriteProduct.id_product}" src="{$img_dir}icon/delete.gif" alt="" />
				</div>
			</div>
			{/foreach}
		</div>
	...
	<p class="footer_links clearfix">
		<a href="{$link->getPageLink('my-account', true)}" class="csbutton cssecond"><img src="{$img_dir}icon/my-account.gif" alt=""/> {l s='Back to Your Account' mod='favoriteproducts'}</a>
		<a href="{$base_dir}" class="csbutton csdefault"><img src="{$img_dir}icon/home.gif" alt="" /> {l s='Home' mod='favoriteproducts'}</a>
	</p>
</div>