...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
		...
		"id_image":	 "{$link->getImageLink($product.link_rewrite, $product.id_image, 'small_default')|addslashes}",
		...
		"name":          "{$product.name|html_entity_decode:2:'UTF-8'|truncate:45:'...':true|escape:'htmlall'}",
