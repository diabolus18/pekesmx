...
<div class="addresses">
	<h3 class="title1">{l s='Your addresses are listed below.'}</h3>
...
<div class="clear address_add"><a href="{$link->getPageLink('address', true)|escape:'html'}" title="{l s='Add an address'}" class="csbutton cssecond">{l s='Add an address'}</a></div>

<p class="footer_links clearfix">
	<a href="{$link->getPageLink('my-account', true)}" class="csbutton cssecond"><img src="{$img_dir}icon/my-account.gif" alt="" class="icon" /> {l s='Back to Your Account'}</a>
	<a href="{$base_dir}" class="csbutton csdefault"><img src="{$img_dir}icon/home.gif" alt="" /> {l s='Home'}</a>
</p>
