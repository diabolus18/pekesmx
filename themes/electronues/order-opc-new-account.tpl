<div id="opc_new_account" class="opc-main-block">
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")}" method="post" id="login_form" class="std">
		<div class="fieldset">
			...
			<div id="login_form_content" style="display:none;">
				...
				<div class="cslogin cslogin_right">
					<label for="login_passwd">{l s='Password'}</label>
					<span><input type="password" id="login_passwd" name="login_passwd" /></span>
					<p class="lost_password"><a href="{$link->getPageLink('password', true)}" class="lost_password">{l s='Forgot your password?'}</a></p>
				</div>
				<p class="submit">
					{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
					<input type="submit" id="SubmitLogin" name="SubmitLogin" class="csbutton csdefault" value="{l s='Login'}" />
				</p>
			</div>
		</div>
	</form>
	<form action="javascript:;" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<div class="fieldset">
			<h3 id="new_account_title" class="title1">{l s='New Customer'}</h3>
			<div id="opc_account_choice">
				<div class="opc_float">
					<p class="title_block">{l s='Instant Checkout'}</p>
					<p>
						<input type="button" class="exclusive_large csbutton cssecond" id="opc_guestCheckout" value="{l s='Guest checkout'}" />
					</p>
				</div>
				...
				<div class="opc_float">
					...
					<p>
						<input type="button" class="csbutton cssecond" id="opc_createAccount" value="{l s='Create an account'}" />
					</p>
				</div>
				<div class="clear"></div>
			</div>
			<div id="opc_account_form">
				...
				{/if}
				<h3 class="title1">{l s='Delivery address'}</h3>
				{$stateExist = false}
				{$postCodeExist = false}
				{$dniExist = false}
				...
				<p class="submit">
					<input type="submit" class="csbutton csdefault exclusive button" name="submitAccount" id="submitAccount" value="{l s='Save'}" />
				</p>
