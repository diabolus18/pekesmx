...
{else}
	<h3 class="title1">{l s='Please be sure to update your personal information if it has changed.'}</h3>
	...
	<form action="{$link->getPageLink('identity', true)|escape:'html'}" method="post" class="std">
		<div class="fieldset">
			...
			{/if}
			<p class="submit">
				<input type="submit" class="csbutton csdefault" name="submitIdentity" value="{l s='Save'}" />
			</p>
...
<p class="footer_links clearfix">
	<a href="{$link->getPageLink('my-account', true)}" class="csbutton cssecond"><img src="{$img_dir}icon/my-account.gif" alt="" /> {l s='Back to Your Account'}</a>
