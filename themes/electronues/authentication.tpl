...
{literal}
	...
	<form action="{$link->getPageLink('authentication', true)}" method="post" id="create-account_form" class="std cslogin">
		<div class="fieldset">
			<h3 class="title1">{l s='Create an account'}</h3>
			<div class="form_content clearfix">
				...
				<p class="submit">
					...
					<input type="submit" id="SubmitCreate" name="SubmitCreate" class="csbutton cssecond" value="{l s='Create an account'}" />
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="login_form" class="std cslogin">
		<div class="fieldset">
			<h3 class="title1">{l s='Already registered?'}</h3>
			<div class="form_content clearfix">
				<p class="text">
				...
				<p class="submit">
					{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
					<input type="submit" id="SubmitLogin" name="SubmitLogin" class="csbutton csdefault" value="{l s='Log in'}" />
				</p>
			</div>
		</div>
	</form>
...
<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="account-creation_form" class="std">
	...
	<div class="account_creation fieldset">
		<h3 class="title1">{l s='Your personal information'}</h3>
		<p class="radio required">
			<span>{l s='Title'}</span>
			{foreach from=$genders key=k item=gender}
				<input type="radio" name="id_gender" id="id_gender{$gender->id}" value="{$gender->id}" {if isset($smarty.post.id_gender) && $smarty.post.id_gender == $gender->id}checked="checked"{/if} />
	...
	<div class="account_creation fieldset">
		<h3 class="title1">{l s='Your address'}</h3>
		{foreach from=$dlv_all_fields item=field_name}
	...
	<p class="cart_navigation required submit">
		...
		{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
		<input type="submit" name="submitAccount" id="submitAccount" value="{l s='Register'}" class="csbutton csdefault" />
