...
<form action="{$link->getPageLink('address', true)|escape:'html'}" method="post" class="std" id="add_address">
	<div class="fieldset">
		<h3 class="title1">{if isset($id_address)}{l s='Your address'}{else}{l s='New address'}{/if}</h3>
{assign var="stateExist" value=false}
	...
	<p class="cart_navigation required submit">
		...
		<input type="submit" name="submitAddress" id="submitAddress" value="{l s='Save'}" class="csbutton csdefault button" />
	</p>
</form>
