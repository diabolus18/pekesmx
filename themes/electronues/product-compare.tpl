...
{/if}
	<form method="post" action="{$link->getPageLink('products-comparison')|escape:'html'}" onsubmit="true" class="product_compare">
		<p>
		<input type="submit" id="bt_compare" class="csbutton cssecond" value="{l s='Compare'}" />
