...
{if !$opc}
	<p class="cart_navigation submit">
		...
		{if $back}
			<a href="{$link->getPageLink('order', true, NULL, "step=0&amp;back={$back}")}" title="{l s='Previous'}" class="csbutton cssecond">&laquo; {l s='Previous'}</a>
		{else}
			<a href="{$link->getPageLink('order', true, NULL, 'step=0')}" title="{l s='Previous'}" class="csbutton cssecond">&laquo; {l s='Previous'}</a>
		{/if}
