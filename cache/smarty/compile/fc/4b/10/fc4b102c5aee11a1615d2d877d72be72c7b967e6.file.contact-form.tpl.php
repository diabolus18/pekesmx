<?php /* Smarty version Smarty-3.1.14, created on 2014-06-25 09:15:38
         compiled from "/home/pekesmx/www/prestashop/themes/electronues/contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:199135401353aad98ad3e725-12441684%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fc4b102c5aee11a1615d2d877d72be72c7b967e6' => 
    array (
      0 => '/home/pekesmx/www/prestashop/themes/electronues/contact-form.tpl',
      1 => 1401262786,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '199135401353aad98ad3e725-12441684',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53aad98b2ba986_03539853',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53aad98b2ba986_03539853')) {function content_53aad98b2ba986_03539853($_smarty_tpl) {?>
...
" method="post" class="std" enctype="multipart/form-data">
		<div class="fieldset">
			<h3 class="title1"><?php echo smartyTranslate(array('s'=>'send a message'),$_smarty_tpl);?>
</h3>
			<p class="select">
...
" <?php if (isset($_REQUEST['id_contact'])&&$_REQUEST['id_contact']==$_smarty_tpl->tpl_vars['contact']->value['id_contact']){?>selected="selected"<?php }?>><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['contact']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</option>
				<?php } ?>
				</select>
			</p>
...
" class="desc_contact" style="display:none;">
			...
			<p class="text">
				...
				<?php if (isset($_smarty_tpl->tpl_vars['customerThread']->value['email'])){?>
					<input type="text" id="email" name="from" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['customerThread']->value['email'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" readonly="readonly" />
				<?php }else{ ?>
					<input type="text" id="email" name="from" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['email']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
				<?php }?>
			</p>
...
" readonly="readonly" />
		...
		<p class="textarea">
			<label for="message"><?php echo smartyTranslate(array('s'=>'Message'),$_smarty_tpl);?>
			 ...
			 <textarea id="message" name="message" rows="15" cols="10"><?php if (isset($_smarty_tpl->tpl_vars['message']->value)){?><?php echo stripslashes(mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['message']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8'));?>
<?php }?></textarea>
		</p>
		<p class="submit">
