<?php /* Smarty version Smarty-3.1.14, created on 2014-06-18 13:28:03
         compiled from "/home/pekesmx/www/prestashop/themes/electronues/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:29795060853a1da33f10fb6-55737924%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a7b73351e814c93fd79615d3924be142ad9ef3ba' => 
    array (
      0 => '/home/pekesmx/www/prestashop/themes/electronues/modules/blockcart/blockcart.tpl',
      1 => 1401262786,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '29795060853a1da33f10fb6-55737924',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53a1da3452df85_14250356',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53a1da3452df85_14250356')) {function content_53a1da3452df85_14250356($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/pekesmx/www/prestashop/tools/smarty/plugins/modifier.replace.php';
?>
...
<?php }?>
				...
				<span class="remove_link"><?php if (!isset($_smarty_tpl->tpl_vars['customizedDatas']->value[$_smarty_tpl->tpl_vars['productId']->value][$_smarty_tpl->tpl_vars['productAttributeId']->value])&&($_smarty_tpl->tpl_vars['product']->value['total']>0)){?><a title="remove" rel="nofollow" class="ajax_cart_block_remove_link" title="<?php echo smartyTranslate(array('s'=>'remove this product from my cart','mod'=>'blockcart'),$_smarty_tpl);?>
" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete&amp;id_product=".((string)$_smarty_tpl->tpl_vars['product']->value['id_product'])."&amp;ipa=".((string)$_smarty_tpl->tpl_vars['product']->value['id_product_attribute'])."&amp;id_address_delivery=".((string)$_smarty_tpl->tpl_vars['product']->value['id_address_delivery'])."&amp;token=".((string)$_smarty_tpl->tpl_vars['static_token']->value),true);?>
...
" rel="nofollow" title="remove"> </a></div>
...
?>
					...
					<dt class="bloc_cart_voucher" id="bloc_cart_voucher_<?php echo $_smarty_tpl->tpl_vars['discount']->value['id_discount'];?>
">
						<span class="quantity">1x</span>
						<span class="name" title="<?php echo $_smarty_tpl->tpl_vars['discount']->value['description'];?>
...
" class="icon" /></a>
						...
						<span class="price">-<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==1){?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['discount']->value['value_tax_exc']),$_smarty_tpl);?>
...
<?php }?></span>						
		...
		<div id="cart-prices">
			...
			<span id="cart_block_shipping_cost" class="ajax_cart_shipping_cost"><?php echo $_smarty_tpl->tpl_vars['shipping_cost']->value;?>
</span>
			</p>			
...
" id="button_order_cart" class="csbutton csdefault" title="<?php echo smartyTranslate(array('s'=>'Check out','mod'=>'blockcart'),$_smarty_tpl);?>
...
" class="csbutton cssecond" title="<?php echo smartyTranslate(array('s'=>'View my shopping cart','mod'=>'blockcart'),$_smarty_tpl);?>
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'Cart','mod'=>'blockcart'),$_smarty_tpl);?>
</a><?php }?>
		</p>
	</div>
