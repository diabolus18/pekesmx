<?php /* Smarty version Smarty-3.1.14, created on 2014-06-19 10:11:32
         compiled from "/home/pekesmx/www/prestashop/themes/electronues/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:140813174153a2fda4abb329-63119285%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b6df82659ee862756d4c935a3d1b59c6aa446d4b' => 
    array (
      0 => '/home/pekesmx/www/prestashop/themes/electronues/authentication.tpl',
      1 => 1401262786,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '140813174153a2fda4abb329-63119285',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53a2fda57e8111_08017648',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53a2fda57e8111_08017648')) {function content_53a2fda57e8111_08017648($_smarty_tpl) {?>
...
" method="post" id="create-account_form" class="std cslogin">
		<div class="fieldset">
			<h3 class="title1"><?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
</h3>
...
" /><?php }?>
					<input type="submit" id="SubmitCreate" name="SubmitCreate" class="csbutton cssecond" value="<?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
" />
...
" method="post" id="login_form" class="std cslogin">
		<div class="fieldset">
			<h3 class="title1"><?php echo smartyTranslate(array('s'=>'Already registered?'),$_smarty_tpl);?>
</h3>
			<div class="form_content clearfix">
				<p class="text">
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'Forgot your password?'),$_smarty_tpl);?>
				...
				<p class="submit">
					<?php if (isset($_smarty_tpl->tpl_vars['back']->value)){?><input type="hidden" class="hidden" name="back" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" /><?php }?>
					<input type="submit" id="SubmitLogin" name="SubmitLogin" class="csbutton csdefault" value="<?php echo smartyTranslate(array('s'=>'Log in'),$_smarty_tpl);?>
" />
				</p>
			</div>
		</div>
...
?>
							<option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['id_country'];?>
"<?php if ((isset($_POST['id_country_invoice'])&&$_POST['id_country_invoice']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country_invoice'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])){?> selected="selected"<?php }?>><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</option>
							<?php } ?>
						</select>
					</p>
...
" method="post" id="account-creation_form" class="std">
	...
	<div class="account_creation fieldset">
		<h3 class="title1"><?php echo smartyTranslate(array('s'=>'Your personal information'),$_smarty_tpl);?>
</h3>
		<p class="radio required">
			<span><?php echo smartyTranslate(array('s'=>'Title'),$_smarty_tpl);?>
</span>
...
<?php }?>" />
	...
	<div class="account_creation fieldset">
		<h3 class="title1"><?php echo smartyTranslate(array('s'=>'Your address'),$_smarty_tpl);?>
</h3>
		<?php  $_smarty_tpl->tpl_vars['field_name'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['field_name']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['dlv_all_fields']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['field_name']->key => $_smarty_tpl->tpl_vars['field_name']->value){
...
<?php }?>" />
	...
	<div class="account_creation dni fieldset">
